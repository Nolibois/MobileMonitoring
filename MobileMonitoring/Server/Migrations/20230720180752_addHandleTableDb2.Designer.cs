...
namespace MobileMonitoring.Server.Migrations
{
    ...
    [Migration("20230720180752_addHandleTableDb2")]
    partial class addHandleTableDb2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MobileMonitoring.Shared.Email", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdEmail = 1,
                            CreationDate = new DateTime(2023, 7, 20, 20, 7, 52, 354, DateTimeKind.Local).AddTicks(9690),
                            EmailStatusId = 1,
